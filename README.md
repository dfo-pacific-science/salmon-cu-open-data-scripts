...
output/    - CSV files generated by the scripts (also excluded from GitHub via .gitignore)
...
3.  Open each script in RStudio. Run it with teh sub folders script last.
...
- Output files generated by the scripts are not included in the repository and will not be tracked by Git (i.e., they will be created on your local computer but will not be uploaded to GitHub.)
